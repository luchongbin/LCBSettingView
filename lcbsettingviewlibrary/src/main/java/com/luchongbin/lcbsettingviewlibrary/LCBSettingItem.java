package com.luchongbin.lcbsettingviewlibrary;
 ...
 * 时间：2016/12/21 10:32
 */
public class LCBSettingItem extends RelativeLayout {
    /*左侧显示文本*/
    ...
    /*点击事件*/
    private OnLCBSettingItemClick mOnLCBSettingItemClick;

    public LCBSettingItem(Context context) {
        this(context, null);
    }

    public LCBSettingItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LCBSettingItem(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRightIcon_check.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (mOnLCBSettingItemClick!=null) {
                    mOnLCBSettingItemClick.click(isChecked);
                }
            }
        });
    ...
    public void setmOnLSettingItemClick(OnLCBSettingItemClick mOnLSettingItemClick) {
        this.mOnLCBSettingItemClick = mOnLSettingItemClick;
    }
    ...
    public void clickOn() {
        switch (mRightStyle) {
            case 0:
            case 1:
                if (null != mOnLCBSettingItemClick) {
                    mOnLCBSettingItemClick.click(mChecked);
                }
                break;
            case 2:
                //选择框切换选中状态
    ...
    public interface OnLCBSettingItemClick {
